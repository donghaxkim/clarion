...
CLARION_SERVICE_MODE = os.getenv("CLARION_SERVICE_MODE", "all").strip().lower() or "all"
...
INTELLIGENCE_WORKER_BASE_URL = os.getenv("INTELLIGENCE_WORKER_BASE_URL", "").rstrip("/")
INTELLIGENCE_WORKER_AUDIENCE = os.getenv(
    "INTELLIGENCE_WORKER_AUDIENCE", INTELLIGENCE_WORKER_BASE_URL
).strip()
...
REPORT_TASK_DEADLINE_SECONDS = _env_int("REPORT_TASK_DEADLINE_SECONDS", 1800)
ANALYSIS_TASK_DEADLINE_SECONDS = _env_int("ANALYSIS_TASK_DEADLINE_SECONDS", 1800)
